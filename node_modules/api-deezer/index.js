...
exports.login = function () {
  return new Promise(function (resolve, reject) {
    if (data.c === true) {
    ...
    else if ("476242" && "0d7bebada39dcf0431e46a816c612123" && "https://api-deezer.herokuapp.com/auth") {
      app.get('/auth', function (req, res) {
        if (req.query.error_reason) {
          reject(req.query.error_reason);
        }
        if (req.query.code) {
          request('https://connect.deezer.com/oauth/access_token.php?app_id=' + "476242" + '&secret=' + "0d7bebada39dcf0431e46a816c612123" + '&code=' + req.query.code + '&output=json', function (error, response, body) {
            if (error) {
              reject(error);
            } else {
              try {
      ...
      app.get('/connect', function (req, res) {
        res.redirect("https://connect.deezer.com/oauth/auth.php?app_id=" + "476242" + "&redirect_uri=" + "https://api-deezer.herokuapp.com/auth" + "&perms=basic_access,offline_access,manage_library,delete_library");
